 ...
 */
public class ReuqestInvokerMsg extends INotifyMsg.Impl<ReuqestInvokerMsg> implements INotifyMsg.Invoker {
    /**
     * 取消请求
     */
    public static final INotifyMsg.Invoker CANCEL_MSG = new ReuqestInvokerMsg().type("cancel");
